...
#define Mt4SourceDir ReleaseRoot + "\MT4"
...
AppSupportURL=https://github.com/nguemechieu/ZONES
...
SetupIconFile=..\src\assets\Zones.ico
...
Source: "{#DocsSourceDir}\*"; DestDir: "{app}\docs"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#Mt4SourceDir}\*"; DestDir: "{app}\MT4"; Flags: ignoreversion recursesubdirs createallsubdirs

[Icons]
Name: "{group}\ZONES"; Filename: "{app}\{#AppExeName}"; WorkingDir: "{commonappdata}\ZONES"
Name: "{group}\Documentation"; Filename: "{app}\docs"; WorkingDir: "{app}\docs"
Name: "{commondesktop}\ZONES"; Filename: "{app}\{#AppExeName}"; WorkingDir: "{commonappdata}\ZONES"; Tasks: desktopicon

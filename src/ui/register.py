...
class Register(tkinter.Frame):
    def __init__(self, parent, controller):
        ...
        self.master = parent
        self.config(bg="#6699ff", highlightbackground="#6699ff", highlightthickness=10, width=1000, height=600)
        ...
        self.register_button = Button(self.master, text="SUBMIT",
                                      command=lambda: self.register_user(self.usernames.get(), self.password.get(),
    ...
    def register_user(
        ...
        try:
            ...
            result = self.controller.db.cur.execute(
                "INSERT INTO " + self.controller.db.database + "users (username, password, first_name, last_name, "
                                                               "email, phone,"
                                                               " ) VALUES (%s, %s, %s, %s,"
                                                               "%s, %s)",
